      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('global.edit_geofence') }}</a>
          </div>
        </div>
      </nav>
    </div>
...
echo Former::select()
  ->name('group')
  ->forceValue($geofence->location_group_id)
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" name="radius" id="radius" required min="50" value="{{ $geofence->radius }}">
