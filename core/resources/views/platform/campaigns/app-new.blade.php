      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('global.new_app') }}</a>
          </div>
        </div>
      </nav>
        ...
        <div class="panel panel-default">
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="api_token" id="api_token" value="{{ str_random(60) }}" required autocomplete="off">
            </div>
