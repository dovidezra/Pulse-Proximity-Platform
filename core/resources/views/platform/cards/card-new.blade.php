      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('global.new_card') }}</a>
          </div>
        </div>
      </nav>
    </div>
...
foreach($location_groups as $location_group)
{
  ...
  {
    echo '<option value="geofence' . $geofence->id . '" data-type="geofence">' . $geofence->name . '</option>';
  }

  foreach($beacons_in_group as $beacon)
  {
    echo '<option value="beacon' . $beacon->id . '" data-type="beacon">' . $beacon->name . '</option>';
  }
        ...
        <div class="panel panel-default">
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control editor-basic" name="content" rows="12"></textarea>
            </div>
          </fieldset>
        </div>
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" id="icon" name="icon" autocomplete="off" value="">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" class="form-control" id="image" name="image" autocomplete="off" value="">
                <div class="input-group-btn add-on">
...
?>
            <div class="col-md-6">
              <div class="form-group">
                <div class="checkbox checkbox-primary">
                  <input name="categories[]" id="{{ $category->name }}" type="checkbox" value="{{ $category->id }}" class="category_select">
